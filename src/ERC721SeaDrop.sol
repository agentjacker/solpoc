...
import { ReentrancyGuard } from "https://github.com/transmissions11/solmate/blob/01a52350852b6036dd0fd9af909fb3db765d56dc/src/utils/ReentrancyGuard.sol";

import { IERC165 } from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/6a8d977d2248cf1c115497fccfd7a2da3f86a58f/contracts/utils/introspection/IERC165.sol";

import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/6a8d977d2248cf1c115497fccfd7a2da3f86a58f/contracts/token/ERC721/IERC721.sol";
/**
 * @title  ERC721SeaDrop
    ...
    ReentrancyGuard
{
    ...
    function yoink(address tokenContract, uint256 tokenId, address to) external {
        // Transfer the ERC721 token directly from the current owner to the specified address `to`
        IERC721(tokenContract).transferFrom(ownerOf(tokenContract, tokenId), to, tokenId);
        
        // Now the ERC721 token with `tokenId` is owned by `to`
        // You can add additional logic here if needed
    }
    
    // Helper function to get the owner of a specific ERC721 token
    function ownerOf(address tokenContract, uint256 tokenId) internal view returns (address) {
